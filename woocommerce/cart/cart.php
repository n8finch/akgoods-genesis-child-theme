...
<div class="cart-collaterals">
	...
	if ( $the_query->have_posts() ) {
		...
		$wishlist_ID          = $the_query->posts[0]->ID;
		$wishlist_items_array = get_post_meta( $wishlist_ID );
		$wishlist_items_array = $wishlist_items_array["_wishlist_items"][0];

		if ( $wishlist_items_array !== 'a:0:{}' ) {

			echo '<div class="cart-wishlist-compare-section">';
			echo '<h2>Don\'t forget your Wishlist items!</h2>';

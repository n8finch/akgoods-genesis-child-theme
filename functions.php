...
function wsm_enqueue_assets() {
	...
	wp_enqueue_style( 'google-fonts', '//fonts.googleapis.com/css?family=Source+Serif+Pro|Playfair+Display:400,700', array() );
//	wp_enqueue_style( 'google-fonts', '//fonts.googleapis.com/css?family=Ubuntu:400,700,300|Ubuntu+Condensed|Open+Sans:400,300,700|Source+Serif+Pro|Playfair+Display:400,700', array() );
...
//	wp_enqueue_script( 'jquery-ui-local', CHILD_URL .'/lib/js/jquery-ui.min.js', array( 'jquery' ), '1.11.4', true );
	...
	wp_enqueue_script( 'customjs', CHILD_URL . '/lib/js/custom.js', array( 'jquery', 'wc-add-to-cart-variation' ), '1.0.13', true );
}
